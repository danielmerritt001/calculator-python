...
btn_plus = tk.Button(root, text='+', command=lambda: add_to_calculation("+"), width=2, font=("Arial", 15))
btn_plus.grid(row=2, column=4)
btn_minus = tk.Button(root, text='-', command=lambda: add_to_calculation("-"), width=2, font=("Arial", 15))
btn_minus.grid(row=3, column=4)
btn_multiply = tk.Button(root, text='*', command=lambda: add_to_calculation("*"), width=2, font=("Arial", 15))
btn_multiply.grid(row=4, column=4)
btn_divide = tk.Button(root, text='/', command=lambda: add_to_calculation("/"), width=2, font=("Arial", 15))
btn_divide.grid(row=5, column=4)
btn_open = tk.Button(root, text='(', command=lambda: add_to_calculation("("), width=4, font=("Arial", 15))
btn_open.grid(row=5, column=1)
btn_close = tk.Button(root, text=')', command=lambda: add_to_calculation(")"), width=4, font=("Arial", 15))
